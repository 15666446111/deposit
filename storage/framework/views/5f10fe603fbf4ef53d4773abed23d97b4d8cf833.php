...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body>
        <img src="<?php echo e(asset('images/jq.png')); ?>" alt="" style="width: 100%;">
            ...
            <div class="weui-cell">
                ...
                <div class="weui-msg__text-area">
                    <p class="weui-msg__desc">
                        注：该款产品开通服务后，请您于30个自然日内交易一笔 <?php echo e($amounts); ?> 元以上金额，否则系统将扣除您"信用借还"抵押的99元押金，请您按要求使用产品。
                    </p>
                </div>
        ...
        <script>
            ...
            btn.addEventListener('click', function(){
                ...
                $.ajax({
                    url: "/setName",
                    data: {name: $("#name").val(),mobile: $("#mobile").val(), order: "<?php echo e($order->id); ?>"},
                    type: "POST",
                    dataType: "json",
                ...
                ap.tradePay({
                  orderStr: "<?php echo $FundAuthOrder; ?>"
                }, function(res){
                    if (res.resultCode === "9000") {
                        ap.redirectTo("http://deposit.lswlpay.com/Ali/orderStatus/" + "<?php echo e($order->order_no); ?>");
                        //$.alert("订单支付成功 TO::!");
                    }
