                ...
                <div class="row clearfix">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" class="form-control" value="<?php echo e(old('oldpass')); ?>" placeholder="原先的旧密码" name="oldpass">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-line">
                                <input type="password" class="form-control" value="<?php echo e(old('newpass')); ?>" placeholder="新的密码,6位字符以上" name="newpass">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-line">
                                <input type="password" class="form-control" value="<?php echo e(old('conpass')); ?>" placeholder="确认新密码" name="conpass">
                            </div>
                        </div>
                        <div class="form-group">
